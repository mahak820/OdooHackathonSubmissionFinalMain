...
const Hero4 = () => {
  return (
    ...
    <div className="relative min-h-screen w-full  grid-background-hero4">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center md:justify-between w-full px-4 mx-auto" style={{ minHeight: '600px', width: '1300px' }}>
            ...
            <div className="md:w-1/2 text-center md:text-left">
                          <motion.h1
                            ...
                            className="text-4xl md:text-4xl lg:text-5xl font-bold text-black max-w-4xl leading-relaxed lg:leading-snug mb-8"
                          >
