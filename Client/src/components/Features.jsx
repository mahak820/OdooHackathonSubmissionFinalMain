...
export default function Features() {
  ...
  return (
    <div className="min-h-screen relative bg-gradient-to-b from-black to-[#1C1536] to-40% px-8 py-12 md:px-0">
...
      </div>
        ...
        <div className="text-center ">
          ...
          <h2 className="font-epilogue text-5xl md:text-6xl font-bold text-white mb-6">
            The Audio Quality
                  ...
                  <ScrollObserver.Trigger id={`features-${index}`} key={index} className="relative scroll-mt-[50vh]">
                    {(isActive) => (
                      <div
                        ...
                        <div className="font-epilogue text-4xl text-[#A9CCE3] font-bold">{item.title}</div>
